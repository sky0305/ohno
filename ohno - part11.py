...
while True:
    play_mode = input(''' - [E]asy   mode (show "!" when your last step was different from the answer)\n - [M]edium mode (show "?" when the number in certain cell exceed it given by question.)\n - [H]ard   mode (no hint)\nWhich mode do you want to play in? [E]/[M]/[H]: ''').strip().lower()
